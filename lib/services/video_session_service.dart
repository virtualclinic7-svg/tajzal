...
class VideoSessionService {
  ...
  Future<VideoTokenResponse> requestToken(
  ...
  Future<void> startScreenShare() async {
    if (_engine == null) throw Exception('المحرك غير مهيأ');

    try {
      // On Android/iOS we use startScreenCapture
      ...
      // Update channel media options to publish screen track instead of camera
      ...
      throw Exception('فشل في بدء مشاركة الشاشة: ${e.toString()}');
    }
  }
  ...
  Future<void> stopScreenShare() async {
    ...
    try {
      ...
      throw Exception('فشل في إيقاف مشاركة الشاشة: ${e.toString()}');
    }
  }
