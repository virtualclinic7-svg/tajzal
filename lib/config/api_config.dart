...
class ApiConfig {
  ...
  // static const String _devBaseUrl = 'https://tajazalclinics.online/api';
  // static const String _devBaseUrlPhysicalDevice =
  //     'https://tajazalclinics.online/api';
  // static const String _prodBaseUrl = 'https://tajazalclinics.online/api';

  static const String _devBaseUrl = 'https://tajazalclinics.online/api';
  static const String _devBaseUrlPhysicalDevice = 'https://tajazalclinics.online/api';
  static const String _prodBaseUrl = 'https://tajazalclinics.online/api';
