  ...
  factory Appointment.fromJson(Map<String, dynamic> json) {
    ...
    if (json['doctor'] != null && json['doctor'] is Map) {
      doctor = DoctorInfo.fromJson(json['doctor']);
        ...
        (json['doctorId']['name'] != null || json['doctorId']['_id'] != null)) {
    ...
    if (json['service'] != null && json['service'] is Map) {
      service = ServiceInfo.fromJson(json['service']);
        ...
        (json['serviceId']['name'] != null ||
            json['serviceId']['_id'] != null)) {
      service = ServiceInfo.fromJson(json['serviceId']);
    }

    // Extract patient info - check for populated 'patient' field first, then fall back to 'patientId' as Map
    PatientInfo? patient;
    if (json['patient'] != null && json['patient'] is Map) {
      patient = PatientInfo.fromJson(json['patient']);
    } else if (json['patientId'] is Map &&
        (json['patientId']['name'] != null ||
            json['patientId']['_id'] != null)) {
...
class PatientInfo {
  ...
  PatientInfo({required this.id, required this.name, this.phone, this.avatar});
