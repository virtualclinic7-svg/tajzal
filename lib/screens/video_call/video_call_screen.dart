...
class _VideoCallScreenState extends State<VideoCallScreen> {
    ...
    try {
      ...
      if (!permissionsGranted) {
        setState(() {
          ...
          _errorMessage =
              'يجب منح صلاحيات الكاميرا والميكروفون لاستخدام مكالمة الفيديو';
        });
        return;
      }
  ...
  Future<void> _toggleScreenShare() async {
    try {
      await _videoService.toggleScreenShare();
      setState(() {
        _isScreenSharing = _videoService.isScreenSharing;
        _isVideoEnabled = _videoService.isVideoEnabled;
      });
    } catch (e) {
      _showError('فشل في مشاركة الشاشة: ${e.toString()}');
    }
  }
                ...
                children: [
                  ...
                  _buildControlButton(
                    icon: _isScreenSharing
                        ...
                        : Iconsax.monitor,
                    label: _isScreenSharing ? 'إيقاف البث' : 'بث الشاشة',
