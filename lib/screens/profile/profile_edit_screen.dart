  ...
  Future<void> _pickImage() async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(l10n.profImagePickFailed)));
    }
  }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(l10n.profProfileUpdated),
      ...
      if (mounted) {
        final l10n = AppLocalizations.of(context)!;
        String errorMessage = l10n.profUpdateFailed;
        if (e.toString().contains('مستخدم بالفعل')) {
          errorMessage = l10n.profPhoneAlreadyUsed;
        } else {
